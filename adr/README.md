...
| [0027](0027-data-sources-fetch-provider-interim.md) | Data & Sources fetch provider interim: injectable, non-fetching placeholder (**Partially superseded by [0046](0046-data-sources-alpha-vantage-partial-resolution.md)** — MARKET_DATA/NEWS/EARNINGS resolved, FILING/REPORT/PRESENTATION/EXTERNAL_DATASET still open) | Data & Sources (02) |
| [0028](0028-memory-mem0-llm-embedding-provider-interim.md) | Mem0 LLM/embedding provider interim: deferred to DefaultInfrastructure (**Partially superseded by [0045](0045-memory-mem0-embedding-resolved-fastembed.md)** — embedding half resolved, LLM-extraction half still open) | Memory (06) |
...
| [0034](0034-retrieval-corrective-external-search-provider-interim.md) | Corrective retrieval external search provider interim: injectable, empty-by-default placeholder (**Superseded by [0047](0047-retrieval-tavily-corrective-search-resolved.md)**) | Retrieval & Context (05) |
...
| [0040](0040-interaction-notification-delivery-channel-interim.md) | Delivery channel interim: injectable, non-sending placeholder (**Superseded by [0048](0048-interaction-notification-resend-delivery-resolved.md)**) | Interaction & Notification (13) |
...
| [0045](0045-memory-mem0-embedding-resolved-fastembed.md) | Mem0 embedding gap resolved: Mem0EntityLinker via mem0ai's local fastembed embedder, cosine similarity, no API key or account — partially supersedes ADR-0028 (embedding half only) | Memory (06) |
| [0046](0046-data-sources-alpha-vantage-partial-resolution.md) | Data & Sources fetch provider partially resolved: AlphaVantageSourceFetcher for MARKET_DATA (GLOBAL_QUOTE), NEWS (NEWS_SENTIMENT), EARNINGS (EARNINGS) — partially supersedes ADR-0027 | Data & Sources (02) |
| [0047](0047-retrieval-tavily-corrective-search-resolved.md) | Corrective-retrieval search provider resolved: TavilySearchProvider, real Tavily-backed search — supersedes ADR-0034 | Retrieval & Context (05) |
| [0048](0048-interaction-notification-resend-delivery-resolved.md) | Delivery channel resolved: ResendNotificationChannel, User.email added as the missing contact field — supersedes ADR-0040; real delivery pending domain verification on this project's Resend account | Interaction & Notification (13), User & Portfolio (01) |
| [0049](0049-core-entity-repository-layer.md) | Core-entity repository layer: four dataclasses + table-name constants extracted to stdlib-only src/domain.py; c01 re-exports for backward compat; typed columns on users/portfolios/holdings/transactions with MIGRATED_TABLES registry on DefaultInfrastructure; lazy CREATE TABLE removed for these four tables only (MigrationRequiredError); transactions are append-only with broker re-sync duplicate-row risk owned by Upstox broker-integration feature; ADR-0019 reaffirmed and now enforced by compliance test; migration tooling unchanged | User & Portfolio (01), System Infrastructure (18) |

ADR-0004 is partially superseded by ADR-0015, ADR-0020 is superseded by ADR-0042, ADR-0021 is superseded by ADR-0043, ADR-0028 is partially superseded by ADR-0045 (embedding half resolved, LLM-extraction half still open), ADR-0027 is partially superseded by ADR-0046 (MARKET_DATA/NEWS/EARNINGS resolved, FILING/REPORT/PRESENTATION/EXTERNAL_DATASET still open), ADR-0034 is superseded by ADR-0047, and ADR-0040 is superseded by ADR-0048 — see each pair for the full picture; superseded ADRs stay in the folder rather than being deleted.
