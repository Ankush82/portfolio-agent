...
ADR-0004 is partially superseded by ADR-0015, ADR-0020 is superseded by ADR-0042, ADR-0021 is superseded by ADR-0043, ADR-0028 is partially superseded by ADR-0045 (embedding half resolved, LLM-extraction half still open), and ADR-0027 is partially superseded by ADR-0046 (MARKET_DATA/NEWS/EARNINGS resolved, FILING/REPORT/PRESENTATION/EXTERNAL_DATASET still open) — see each pair for the full picture; superseded ADRs stay in the folder rather than being deleted.
